...
<head>
    ...
    <title>SB Admin 2 - Upload Laporan</title>
                ...
                <div class="container-fluid">
                    ...
                    <div style="margin: 50px 50px 50px 50px; padding: 10px" class="shadow-lg">
                        ...
                        <div class="container-fluid">
                            ...
                            <!-- Form Pengajuan -->
                            <form class="user" method="post" action="http://localhost:8080/SIKEL_Ganjil/UpLaporan/UploadLaporan.jsp" enctype="multipart/form-data">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <input name="nama_file" id="exampleEmail" placeholder="Judul Laporan" 
                                           type="text" class="form-control">
                                </div>
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class="">Tanggal Upload</label>
                                    <input name="tanggal_laporan" id="exampleEmail" placeholder="Tanggal Laporan" 
